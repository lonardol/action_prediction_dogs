...
sample.data <- read_delim("data/sample_report_action_prediction_ball_IPwhole_video.txt", na=".", delim="\t")%>%
...
library(cowplot)
pg_m2<-plot_grid(plot_diff_m2_dog_hw, plot_diff_m2_dog_ho, plot_diff_m2_hw_ho, nrow=1, labels=c("A", "B", "C"))
pg_m2
